...
import {Button, Label, Row, Col, Card, CardImg} from 'reactstrap';
...
class Entry extends Component {
    ...
    handleSubmit(values) {
        ...
        //console.log(values.wrappparty);
        if (window.confirm('GO4THETOP 3rd Season 본선 관전을 신청하시겠습니까?')) {
            this.props.postContender(this.props.ctdID, values.email, values.fullname, values.nameread, values.cardname.toUpperCase(),
                (values.wrapparty !== undefined && values.wrapparty === "yes"), false, true, values.snstype, values.snsid, values.message);
        }
    }
    ...
    render() {
        return (
            <div className="container">
                ...
                {/*    </Card>*/}
                {/*</div>*/}
                <h4>예선 참가 신청 기간은 종료되었습니다.</h4>
                <h5>
                    본선의 추가 관람 신청 기간은 10월 31일까지입니다.<br/>
                    예선 참가자는 이미 관람 신청이 되어있으므로, 추가로 신청할 필요가 없습니다.<br/>
                    하나의 이메일 주소로는 최대 1명까지만 신청이 가능합니다.<br/>
                    뒤풀이는 인원과 장소를 논의중이며 신청이 아닌 희망자 체크임을 유의하시기 바랍니다.<br/><br/>
                    * : 필수 항목입니다.
                </h5>
                {/*<h5>* : 필수 항목입니다.</h5>*/}
                <LocalForm onSubmit={(value) => this.handleSubmit(value)}>
                    ...
                    <Row className="form-group">
                        <Label htmlFor="fullname" md={6}>참가자 닉네임(Name) *</Label>
                        <Col md={9}>
                    ...
                    <Row className="form-group">
                        <Label htmlFor="fullname" md={6}>참가자 닉네임 읽는법(How to read your name) *</Label>
                        <Col md={9}>
                    ...
                    <Row className="form-group">
                        <Label htmlFor="wrapparty" md={4}>뒤풀이 참석 희망 *</Label>
                        <Col md={3}>
                            <Control.select model=".wrapparty" id="wrapparty" name="wrapparty">
                    ...
                    <Row className="form-group">
                        <Col md={{size: 10, offset: 2}}>
                            <Button type="submit" color="primary">
                                Let's heat it up with this tournament!
                            </Button>
                        </Col>
                    </Row>
                </LocalForm>
